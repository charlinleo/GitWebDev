...
<head>
    ...
    <title><?php echo e(config('', 'AutoSight')); ?></title>
...
<body class="bg-dark text-white">
    <div id="app">
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top py-3" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="/"><img class="navbar-brand" src="<?php echo e(asset('img/logo2.png')); ?>"
...
<?php /**PATH /Users/charlinleo/Documents/Laravel/webdev/GitWebDev/ALP_webdev/resources/views/layouts/app.blade.php ENDPATH**/ ?>