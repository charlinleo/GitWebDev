...
<?php $__env->startSection('layout_content'); ?>
    ...
    <section class="page-section portfolio" id="portfolio">
                ...
                <?php $__currentLoopData = $product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card mx-auto mb-4" style="width: 50%;">
                        <div class="card-body justify-content-center">
                            ...
                            <p class="card-text text-center">Kategori : <?php echo e($pro->category->category_name); ?></p>
                            <p class="card-text text-center">Harga Products : <?php echo e($pro['product_price']); ?>/pcs</p>
                            
                            <p class="card-text text-center">Deskripsi : <?php echo e($pro['product_desc']); ?></p>
                            ...
                            <p>
                            <form action="<?php echo e(route('product.destroy', $pro->id)); ?>" method="POST" style="display: inline;">
                                <?php echo csrf_field(); ?>
        ...
        <?php if(Auth::check() && Auth::user()->isAdmin()): ?>
            <a href="<?php echo e(route('product.create')); ?>" class="btn btn-success d-grid gap-2">Add Product</a>
        <?php endif; ?>
        </div>
    </section>
