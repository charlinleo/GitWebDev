...
<?php $__env->startSection('layout_content'); ?>
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            <img class="masthead-avatar mb-5" src="<?php echo e(asset('img/logo2.jpeg')); ?>" alt="" />
            ...
            <div class="row justify-content-center">
                <div class="row justify-content-center">
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="mx-auto">
                            <a href="<?php echo e(route('service.index')); ?>"><img class="img-fluid hover-effect" src="<?php echo e(asset('img/logo.jpeg')); ?>" alt="" /></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="row justify-content-center">
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="mx-auto">
                            <a href="<?php echo e(route('product.index')); ?>"><img class="img-fluid hover-effect" src="<?php echo e(asset('img/logo.jpeg')); ?>" alt="" /></a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/charlinleo/Documents/Laravel/webdev/GitWebDev/ALP_webdev/resources/views/index.blade.php ENDPATH**/ ?>